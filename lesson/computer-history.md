...
```{figure} ../images/nepers-sticks.png
Палочки Непера
```
...
```{figure} ../images/schickard-mechanical-calculator.jpg
Механическая счетная машина Шиккарда
```
...
```{figure} ../images/pascaline-internal-device.png
