...
Каждая программа полагает, что единолично владеет всем компьютером.
Ей доступны процессор и оперативная память с байтами от нуля до многих гигабайт.

Операционная система -- это важная системная программа, оживляющая компьютер.
Она устанавливает правила для программ.

## Введение

% Понятие операционной системы
Операционная система располагается программным слоем между аппаратным обеспечением и приложениями компьютера.

```{figure} ../images/OS-placement.svg
```

% Единый программный интерфейс к компьютерному оборудованию для приложений.
Приложения не могут напрямую обратиться к компьютерному оборудованию: диску, монитору, клавиатуре и остальному.
...
% Организует взаимодействие с пользователем.
...
Ядро Ubuntu расположено в каталоге `/boot` и называется `vmlinuz-version-generic`.
