...
```{figure} ../_images/hard-drive.jpg
:height: 200
```

```{figure} ../_images/solid-state-drive.jpg
:height: 200
```
...
```{figure} ../_images/memory-hierarchy.jpg
```
...
```{figure} ../_images/files-and-cataloges.png
```
...
```{figure} ../_images/filesystem-journaling.gif
```
...
```{figure} ../_images/fat32-file-entry.svg
```
...
```{figure} ../_images/fat32-lfn-entry.svg
```
